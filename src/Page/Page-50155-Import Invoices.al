            ...
            group(Action7)
            {
                ...
                action(Release)
                {
                    ...
                    begin
                        ...
                        //Rec.PerformManualRelease(PurchaseHeader);     //PCPL-25/081222
                    end;
                }
                action(Reopen)
                {
                    ...
                    begin
                        CurrPage.SetSelectionFilter(PurchaseHeader);
                        //Rec.PerformManualReopen(PurchaseHeader);      //PCPL-25/081222
                    end;
                }
            }
