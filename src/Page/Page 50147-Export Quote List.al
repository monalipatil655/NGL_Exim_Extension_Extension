page 50147 "Export Quotes"
{
    ...
    AboutTitle = 'About Export quotes';
        ...
        area(processing)
        {
            ...
            group(Action3)
            {
                ...
                action(Release)
                {
                    ...
                    begin
                        CurrPage.SetSelectionFilter(SalesHeader);
                        //PerformManualRelease(SalesHeader);        //PCPL-25/291122
                    end;
                }
                action(Reopen)
                {
                    ...
                    begin
                        CurrPage.SetSelectionFilter(SalesHeader);
                        //PerformManualReopen(SalesHeader);  //PCPL-25/291122
                    end;
                }
            }
