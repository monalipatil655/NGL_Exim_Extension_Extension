        ...
        area(processing)
        {
            ...
            group(Action21)
            {
                ...
                action(Release)
                {
                    ...
                    PromotedOnly = true;
                    ShortCutKey = 'Ctrl+F9';
                    // = 'Release the document to the next stage of processing. When a document is released, it will be included in all availability calculations from the expected receipt date of the items. You must reopen the document before you can make changes to it.';
            ...
            group(Plan)
            {
                ...
                action("Demand Overview")
                {
                    ...
                    Image = Forecast;
                    // = 'Get an overview of demand for your items when planning sales, production, jobs, or service management and when they will be available.';
